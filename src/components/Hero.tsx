      ...
      <div className="container mx-auto px-4 py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Badge variant="secondary" className="mb-8 text-sm font-medium">
            🚀 India's Premier Bug Bounty Platform
          </Badge>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
            Find Bugs,
            <br />
            <span className="text-primary">Earn Bounties</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            Join thousands of security researchers discovering vulnerabilities and earning rewards from top companies worldwide.
          </p>
